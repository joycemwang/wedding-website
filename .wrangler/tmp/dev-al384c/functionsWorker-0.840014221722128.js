...
// .wrangler/tmp/pages-pyaGFc/functionsWorker-0.840014221722128.mjs
var __defProp2 = Object.defineProperty;
var __name2 = /* @__PURE__ */ __name((target, value) => __defProp2(target, "name", { value, configurable: true }), "__name");
var SHEETS_SCOPE = "https://www.googleapis.com/auth/spreadsheets";
var TOKEN_URL = "https://oauth2.googleapis.com/token";
var LOG_RANGE = "'Website Tracking'!A:B";
...
__name2(base64UrlEncodeString, "base64UrlEncodeString");
async function importPrivateKey(pem) {
  const normalized = pem.replace(/\\n/g, "\n");
  const base64Body = normalized.replace(/-----BEGIN PRIVATE KEY-----/, "").replace(/-----END PRIVATE KEY-----/, "").replace(/\s/g, "");
...
var TIMESTAMP_FORMATTER = new Intl.DateTimeFormat("en-US", {
  timeZone: "America/New_York",
  dateStyle: "medium",
  timeStyle: "short"
});
async function appendLogRow(env, name) {
  const accessToken = await getAccessToken(env);
  const timestamp = `${TIMESTAMP_FORMATTER.format(/* @__PURE__ */ new Date())} ET`;
...
__name(appendLogRow, "appendLogRow");
__name2(appendLogRow, "appendLogRow");
...
// .wrangler/tmp/bundle-lRCAZr/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-lRCAZr/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.840014221722128.js.map
